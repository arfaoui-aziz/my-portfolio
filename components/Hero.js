...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="flex flex-col gap-y-12 my-12   items-center md:my-16  md:flex-row md:gap-x-8 md:gap-y-0"
    >
      <div className="flex-1">
        ...
        <div className="flex flex-col md:flex-row ">
          <button className="px-14 py-3 mb-3  font-sans font-semibold   text-white bg-blue rounded-lg md:mr-6 md:mb-0 md:items-center hover:bg-indigo-600 transition duration-200 transform md:hover:scale-110">
            Contact Me
          </button>
        </div>
      </div>
